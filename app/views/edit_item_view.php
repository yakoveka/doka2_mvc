<div id="editHero">
    <form action="/items/confirm_edit/<?php echo str_replace(' ', '_', $data->name); ?>/confirm" class="edit_hero" method="post">
        ...
        Картинка предмета: <input type="text" name="itemPicture" value="<?= $data->picture_url ?>"><br/>
